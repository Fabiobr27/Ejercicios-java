...
<html>
    ...
    <head>
        ...
        <title>Formulario Especificacion</title>
        <style>
    ...
    <body>
        <%            Class.forName("com.mysql.jdbc.Driver");
            ...
            ResultSet listado = s.executeQuery("SELECT NombreMarca, NombreMod , mo.CodigoMod "
        ...
        <div class="wrapper">
            ...
            <!-- Formulario -->
            <form action="grabaEspeci.jsp" method="post" class="login">
                <h2>Inserta Especificacion</h2>
