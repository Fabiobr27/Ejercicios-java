...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <!-- Formulario -->
            <form action="ActualizaMarcas.jsp" method="post" class="login">
                <h2>Modifica Marca</h2>

                <!-- Contenedor del Formulario -->
                <div class="login-container">
                    <input type="hidden"  name="CodigoMarca" value="<%= request.getParameter("CodigoMarca")%>">
                    <label>Nombre Marca</label>
                    <input type="text"  name="NombreMarca" value="<%= request.getParameter("NombreMarca")%>">

                    <label>Año Fundación</label>
                    <input type="text"  name="AñoFundacion" value="<%= request.getParameter("AñoFundacion")%>">
