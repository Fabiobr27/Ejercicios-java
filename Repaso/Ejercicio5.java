public class Ejercicio5{
  public static void main (String [] args){
    ...
    System.out.println();
    System.out.println("El maximo es " + maximo + " y se encuentra en la fila " + filaMaximo + " y en la columna " + columnaMaximo);
    System.out.println("El minimo es " + minimo + " y se encuentra en la fila " + filaMinimo + " y en la columna " + columnaMinimo);
