public class Ejercicio1Arrays{
  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      int fila = Integer.parseInt(System.console().readLine());           //nombreFila.indexOf(coordenadas.charAt(0));
      int columna = Integer.parseInt(System.console().readLine());       //coordenadas.charAt(1) - 1 - 48;
